#
#  Be sure to run `pod spec lint ONTKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                            ONT wallet kit in Objective-C.
                   DESC

  s.homepage     = "https://github.com/AlleniCode/ONTKit"
  ...
  s.author             = { "AlleniCode" => "zhangyutao2014@163.com" }
  # Or just: s.author    = "AlleniCode"
  # s.authors            = { "AlleniCode" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/AlleniCode"
